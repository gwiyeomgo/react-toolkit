          ...
          for (s = 0; s < i.length; ++s)
            if (s !== u) {
              ...
              m === -1
                ...
                bi.call(n, h) ? (n[h] = Xt.combine(n[h], E)) : (n[h] = E);
            }
          return n;
        },
        E_ = function (e, t, r, n) {
...
`,
      ...
      let i = [],
        ...
        s = {
          ...
          9: {
            match: Xe(t.enforceAtxHeadings ? ep : Zd),
            order: 1,
            parse: (h, E, b) => ({
              children: Dn(E, h[2], b),
              id: t.slugify(h[2]),
    ...
    var sI = (e, t) => {
      ...
      dI = (e) => {
        ...
        try {
          ...
          if (
            (B || ((m = null), (h = null), (F = {})),
            n && (!B || o) && (F = Wi(F, { [x]: n }, y.parameters, i, u)),
            a)
          ) {
            if (Array.isArray(a))
              throw new Error(
