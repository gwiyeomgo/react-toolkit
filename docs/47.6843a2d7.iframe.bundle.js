    ...
    ***************************************************************************** */ var buffer,
        ...
        for (
          var wordBreak = {
            ...
            CSSParsedPseudoDeclaration = function (context, declaration) {
              (this.content = parse(context, content, declaration.content)),
                (this.quotes = parse(context, quotes, declaration.quotes));
            },
            CSSParsedCounterDeclaration = function (context, declaration) {
            ...
            ElementContainer = function (context, element) {
        ...
        var toCodePoints = function (str) {
          ...
          TextBounds = function (text, bounds) {
          ...
          TextContainer = function (context, node, styles) {
        ...
        var getCurvePoints = function (x, y, r1, r2, position) {
          ...
          TransformEffect = function (offsetX, offsetY, matrix) {
          ...
          ClipEffect = function (path, target) {
            (this.path = path), (this.target = target), (this.type = 1);
          },
          OpacityEffect = function (opacity) {
          ...
          StackingContext = function (container) {
          ...
          Renderer = function (context, options) {
          ...
          _createClass(CSVLink, [
            ...
            },
            {
              ...
              value: function handleAsyncClick(event) {
                var _this2 = this;
                this.props.onClick(event, function (proceed) {
                  if (!1 === proceed) {
                    event.preventDefault();
                    return;
                  }
...
//# sourceMappingURL=47.6843a2d7.iframe.bundle.js.map
